...
import kotlinx.android.synthetic.main.activity_single_missed_reminder.*
import kotlinx.android.synthetic.main.content_single_missed_reminder.*
import org.joda.time.DateTimeZone
import org.joda.time.format.DateTimeFormat
import java.util.*

class SingleMissedReminderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_single_missed_reminder)

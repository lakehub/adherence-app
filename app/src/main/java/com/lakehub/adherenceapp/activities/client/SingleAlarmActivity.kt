...
import kotlinx.android.synthetic.main.content_single_alarm.*
...
class SingleAlarmActivity : AppCompatActivity() {
    ...
    private fun openOptionMenu(v: View) {
        ...
        popup.setOnMenuItemClickListener { item ->
            when (item.itemId) {
                R.id.edit -> {
                    val myIntent = Intent(this, EditAlarmActivity::class.java)
                ...
                R.id.cancel -> {
                    val myIntent = Intent(this, CancelAlarmActivity::class.java)
                    myIntent.putExtra("docId", docId)
